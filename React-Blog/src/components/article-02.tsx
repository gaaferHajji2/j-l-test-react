...
export default function Article02() {
    return (
        <article className="my-4 shadow">
            <a href="#">
                <img className="hover:opacity-75 w-full object-cover max-h-120" src="https://plus.unsplash.com/premium_photo-1663126827264-409d695e0be7?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
            </a>

            <div className="flex flex-col p-6 pt-2 bg-white">
                <a href="#" className="my-2 text-sm font-bold uppercase border-b-2
                 border-yellow-500 text-blue-600">Imagery</a>
