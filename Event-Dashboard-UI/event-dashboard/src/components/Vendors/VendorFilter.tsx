...
const VendorsFilter = ({ filters, onFilterChange }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          >
            ...
            <option value="pending">{t('vendorStatus.pending')}</option>
            <option value="active">{t('vendorStatus.active')}</option>
            <option value="inactive">{t('vendorStatus.inactive')}</option>
            <option value="rejected">{t('vendorStatus.rejected')}</option>
          </select>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            <span className="text-sm">{t('vendors.submittedAt')}</span>
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
          >
            <span className="text-sm">{t('vendors.businessName')}</span>
